...
@register.inclusion_tag("social/comment_tag.html", name="create-comment-form", takes_context=True)
def create_comment_form(context, replying_to_id=None):
    return {
        ...
        "comment_template_tag_js_included": "comment_template_tag_js_included" in context
    }